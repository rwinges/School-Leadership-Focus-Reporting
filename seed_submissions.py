"""
seed_submissions_v6.py
----------------------
Architecture fix: worked[w] is the hard per-week total.
Category allocation distributes exactly worked[w] hours per week.
Annual percentage targets are met by scaling category distributions.

Key principles:
  - compute_worked_hours() defines the immutable weekly total
  - All category hours sum to exactly worked[w] for every week
  - Annual targets are achieved through proportional scaling, not override
  - Per-week constraints always take priority over annual targets
...
EMPLOYEES = {
    "barbara":  "barbara@ryanwinges.onmicrosoft.com",
    "jacob": "jacob@ryanwinges.onmicrosoft.com",
    "ava":   "ava@ryanwinges.onmicrosoft.com",
}
